...
function Modal() {
  ...
  return (
    ...
    >
      <Dialog
        as="div"
        className="fixed inset-0 z-50 pt-0"
            ...
            <div className="inline-block transform overflow-hidden rounded-2xl bg-black text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl sm:align-middle">
              ...
              <div className="flex px-4 pt-5 pb-2.5 sm:px-6">
                <div className="w-full">
                  <div className="relative flex gap-x-3 pb-4 text-[#6e767d]">
                    <span className="absolute left-5 z-[-1] h-full w-0.5 bg-gray-600" />
                    <img
                      src={post?.userImg}
                      alt=""
                    ...
                    <div className="mt-2 flex-grow">
                      ...
                      <div className="flex items-center justify-between pt-2.5">
                        <div className="flex items-center">
                          <div className="icon">
                            <PhotographIcon className="h-[22px] text-[#1d91d9]" />
                          </div>

                          <div className="icon rotate-90">
                            <ChartBarIcon className="h-[22px] text-[#1d91d9]" />
                          </div>

                          <div className="icon">
                            <EmojiHappyIcon className="h-[22px] text-[#1d91d9]" />
                          </div>

                          <div className="icon">
                            <CalendarIcon className="h-[22px] text-[#1d91d9]" />
                          </div>
                        </div>

                        <button
                          className="rounded-full bg-[#1d91d9] px-4 py-1.5 font-bold text-white shadow-md hover:bg-[#1a8cd8] disabled:cursor-default disabled:opacity-50 disabled:hover:bg-[#1d9bf0]"
                          type="submit"
                          onClick={sendComment}
